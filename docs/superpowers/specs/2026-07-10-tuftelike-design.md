...
1. **Zero-syntax (headline feature):** standard `[^1]` markdown footnotes become numbered sidenotes via a footnote→sidenote transform. Toggle: `footnotes-as-sidenotes: true`.
